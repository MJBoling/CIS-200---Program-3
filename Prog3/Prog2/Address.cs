...
public class Address 
{
    ...
    private string _name = null;     // Address' name
    private string _address1 = null; // First address line
    private string _address2 = null; // Second address line, optional
    private string _city = null;     // Address' city
    private string _state = null;    // Address' state
    private int _zip = 0;         // Address' zip code
